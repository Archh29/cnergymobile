...
function castMemberData($data) {
    ...
    // Handle date fields
    $dateFields = ['bday', 'created_at', 'join_date', 'requested_at', 
                   'coach_approved_at', 'staff_approved_at'];
...
switch ($action) {
    case 'coaches':
        if ($method === 'GET') fetchCoaches($pdo);
        break;
        
    case 'hire-coach':
        if ($method === 'POST') hireCoach($pdo);
        break;
    ...
    case 'approve-member-request':
        if ($method === 'POST') approveMemberRequest($pdo);
        break;
        
    case 'approve-member-request-staff':
        if ($method === 'POST') approveMemberRequestByStaff($pdo);
        break;
        
    case 'reject-member-request':
        if ($method === 'POST') rejectMemberRequest($pdo);
        break;
