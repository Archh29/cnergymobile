...
import 'dart:convert';
import 'day_pass_qr_display_screen.dart';

class DayPassRegistrationScreen extends StatefulWidget {
  @override
  _DayPassRegistrationScreenState createState() => _DayPassRegistrationScreenState();
}

class _DayPassRegistrationScreenState extends State<DayPassRegistrationScreen> {
  ...
  Future<void> _submitDayPassRegistration() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://api.cnergy.site/day_pass_session_api.php'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'action': 'create_day_pass_session',
          'day_pass_name': _nameController.text.trim(),
          'day_pass_type': 'walkin',
      ...
      if (data['success'] == true) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => DayPassQRDisplayScreen(
              sessionData: {
                'id': data['data']['id'],
                'day_pass_name': _nameController.text.trim(),
                'day_pass_type': 'walkin',
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        'Register for day pass access to CNERGY',
                        style: GoogleFonts.poppins(
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: _isLoading ? null : _submitDayPassRegistration,
                    ...
                    child: _isLoading
                        ...
                        : Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 12),
                              Text(
                                'Register for Day Pass - ₱${_walkInPrice.toStringAsFixed(0)}',
                                style: GoogleFonts.poppins(
                                  color: Colors.white,
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
