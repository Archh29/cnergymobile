...
import 'dart:convert';
import './User/services/day_pass_session_service.dart';
import 'day_pass_session_status_screen.dart';

class DayPassQRDisplayScreen extends StatefulWidget {
  final Map<String, dynamic> sessionData;

  const DayPassQRDisplayScreen({
    super.key,
    required this.sessionData,
  });

  @override
  State<DayPassQRDisplayScreen> createState() => _DayPassQRDisplayScreenState();
}

class _DayPassQRDisplayScreenState extends State<DayPassQRDisplayScreen> {
  ...
  Future<void> _checkSessionStatus() async {
    ...
    try {
      final result = await DayPassSessionService.getDayPassSession(
      ...
      if (result['success'] == true && result['data'] != null) {
        ...
        await DayPassSessionService.saveDayPassSessionData(_currentSessionData!);
      } else {
        Get.snackbar(
          'Error',
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                _currentSessionData?['day_pass_name'] ?? 'Unknown',
                                style: GoogleFonts.poppins(
                                  color: Colors.white,
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
                              ...
                              Text(
                                _currentSessionData?['day_pass_type']?.toString().toUpperCase() ?? 'UNKNOWN',
                                style: GoogleFonts.poppins(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Your day pass session is ready! You can now access the gym facilities.',
                        style: GoogleFonts.poppins(
                    ...
                    children: [
                      ...
                      Text(
                        _getStatusText() == 'Pending Payment'
                            ? 'Please proceed to the counter to complete payment and activate your day pass.'
                            : _getStatusText() == 'Approved - Pending Payment'
                                ? 'Your day pass is approved! Please proceed to the counter to complete payment and activate your session.'
                                : _getStatusText() == 'Ready to Use'
                                    ? 'Your day pass is ready! You can now access the gym facilities.'
                                    : 'Your day pass request has been rejected. Please contact staff for assistance.',
                        style: GoogleFonts.poppins(
                          color: Colors.grey[400],
                          fontSize: 14,
                        ),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => DayPassSessionStatusScreen(
