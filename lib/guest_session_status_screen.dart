...
class GuestSessionStatusScreen extends StatefulWidget {
  final Map<String, dynamic> sessionData;

  const GuestSessionStatusScreen({
    super.key,
    required this.sessionData,
  });

  @override
  _GuestSessionStatusScreenState createState() => _GuestSessionStatusScreenState();
}

class _GuestSessionStatusScreenState extends State<GuestSessionStatusScreen> {
